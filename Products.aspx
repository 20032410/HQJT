...
<%@ Register Src="uc/p_left.ascx" TagName="p_left" TagPrefix="uc3" %>
...
<div class="cle"></div>
<div class="ncontent">
<uc3:p_left ID="p_left" runat="server"></uc3:p_left>
...
<div class="ntt">
<h2>产品与服务</h2>
<span>您当前位置：<a href="Default.html">网站首页</a>  >>  <a href="products.html">产品与服务</a> </span></div>
<div class="pro">
...
<div style="height:24px; line-height:24px;  clear:both; padding-bottom:10px;  text-align:right"><webdiyer:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="True" CssClass="anpager"
                                             ...
                                             UrlRewritePattern="./Products{0}.html">
