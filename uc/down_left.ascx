<%@ Control Language="C#" AutoEventWireup="true" CodeFile="down_left.ascx.cs" Inherits="uc_down_left" %>
<div class="nleft">
<div class="nltop"></div>
<div class="nlbg">
<h2>下载中心</h2>
...
<ItemTemplate>
<li><a href="downlist<%#Eval("id") %>.html" class='<%# getCss(Eval("id").ToString()) %>'><%#Eval("title")%></a></li>
 </ItemTemplate>
</asp:Repeater>
</ul>
</div>
