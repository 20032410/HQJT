<%@ Control Language="C#" AutoEventWireup="true" CodeFile="case_left.ascx.cs" Inherits="uc_case_left" %>
<div class="nleft">
<div class="nltop"></div>
<div class="nlbg">
<h2>成功案例</h2>
...
<ItemTemplate>
<li><a href="Caselist<%#Eval("id") %>.html" class='<%# getCss(Eval("id").ToString()) %>'><%#Eval("title")%></a></li>
 </ItemTemplate>
</asp:Repeater>
</ul>
</div>
