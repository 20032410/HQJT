<%@ Control Language="C#" AutoEventWireup="true" CodeFile="inter_left.ascx.cs" Inherits="uc_inter_left" %>
<div class="nleft">
<div class="nltop"></div>
<div class="nlbg">
...
<ItemTemplate>
<li><a href="interview_<%#Eval("id") %>.html" class='<%# getCss(Eval("id").ToString()) %>'><%#Eval("shopname") %></a></li>
 </ItemTemplate>
</asp:Repeater>
</ul>
