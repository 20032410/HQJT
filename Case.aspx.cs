...
public partial class Case : System.Web.UI.Page
{
    ...
    public void bind()
    {
        ...
        if (type != null && type != "")
        {
            sql = "select * from project where type=" + Request.QueryString["type"].ToString() + " order by id desc";
        }
        else
        {
        ...
        if (type != null && type != "")
        {
            string sqls = "select  count(*) from project where  type=" + Request.QueryString["type"].ToString() + "  ";
