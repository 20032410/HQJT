<%@ Page Language="C#" AutoEventWireup="true" CodeFile="net.aspx.cs" Inherits="net" %>
...
<dd class="tr_tit"><a href="netview_<%#Eval("id")%>.html"> <%#Eval("shopname") %></a></dd>
<dd><%#Eval("info") %> </dd>
<dd class="more"><a href="netview_<%#Eval("id")%>.html">>>查看详情</a></dd>
</dl>
</ItemTemplate>
</asp:Repeater>
</div>
