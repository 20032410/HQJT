...
public partial class Planarview : System.Web.UI.Page
{
    public static string id, title, addtime, downurl1, downurl2, downurl3;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["id"] != null && Request.QueryString["id"] != "")
        {
            ...
            if (error.shuzi(Request.QueryString["id"].ToString()))
            {
                ...
                string up = "update product set hits=hits+1 where id=" + Request.QueryString["id"].ToString() + "";
                ...
                {
                    id = set.Tables["sql"].Rows[0]["id"].ToString();
