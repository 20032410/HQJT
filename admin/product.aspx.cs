...
public partial class admin_productuse : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        Response.Redirect("addproduct.aspx?id=" + GridView1.DataKeys[e.NewSelectedIndex].Value + "");


    }
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        string sql = "delete from product where id=" + GridView1.DataKeys[e.RowIndex].Value.ToString() + "";
    ...
    public void selectbook()
    {
        ...
        string sqls = "select count(*) from product ";
    ...
    public void resch()
    {
        ...
        if (TextBox1.Text.Trim() != "")
        {
            ...
            sqls = "select count(*) from product where  ";
            if (!DropDownList1.SelectedValue.Contains("0"))
            {

                type = " type=" + DropDownList1.SelectedValue + " or ";
                string sqld = "select id from producdtype where parent_id=" + DropDownList1.SelectedValue + "";
                ...
                for (int i = 0; i < set.Tables["sql"].Rows.Count; i++)
                {
                    ...
                    string select = "select id from producdtype where parent_id=" + set.Tables["sql"].Rows[i]["id"].ToString() + "";
            ...
            if (type != "")
            {
                sql += "  id in  (select  id from product where" + type + ") and ";
                sqls += "   id in  (select  id from product where" + type + ") and ";
            }
    ...
    public string types(string id)
    {
        ...
        return Class1.OperatorCommandStr("select title from producdtype where id=" + id + "");
    }
