<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adddown.aspx.cs" Inherits="admin_adddown"
    ...
    <script type="text/javascript">
      ...
      <asp:Button ID="UpImg" runat="server" Text="上传" OnClick="UpImg_Click" CssClass="button_on"/></td>
             ...
             <tr>
                <td align="right" style="height: 23px; width: 15%;">
                      本地下载地址：</td>
                <td align="left" colspan="3" style="padding-left: 16px; height: 23px">
                    <asp:TextBox ID="txtProfile" runat="server"  CssClass="inpt1"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;<asp:FileUpload ID="FileUpload2" runat="server" Width="200px"  Height="22"  CssClass="inpt"/>
      <asp:Button ID="Upfile" runat="server" Text="上传" OnClick="Upfile_Click" CssClass="button_on"/>  文件大的请通过ftp上传至后台目录upfile文件夹、手动输入下载地址</td></td>
            ...
            <td align="right" style="height: 24px; width: 15%;">
                    多特下载地址：</td>
                <td align="left" style="padding-left: 16px; height: 24px;" colspan="3">
                    <asp:TextBox ID="downurl2" runat="server" CssClass="inpt" Width="200px"></asp:TextBox></td>
               </tr> 
            ...
            <td align="right" style="height: 24px; width: 15%;">
                    华军下载地址：</td>
                <td align="left" style="padding-left: 16px; height: 24px;" colspan="3">
                    <asp:TextBox ID="downurl3" runat="server" CssClass="inpt" Width="200px"></asp:TextBox></td>
               </tr> 
