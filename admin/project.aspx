    ...
    <form id="Form1" runat="server">
        <table style="width: 100%;" cellspacing="1" border="0" bgcolor="#3e97b9" cellpadding="0">
            <tr class="title">
                <td colspan="2" align="left" class="tb" style="height: 20px; text-align: left;">
                    <strong>案例信息管理(搜索)：</strong>
                </td>
            </tr>
            <tr>
                <td style="height: 27px; text-align: left;" align="right" colspan="2">
                    案例搜索：<asp:TextBox ID="TextBox1" runat="server" Width="130px" CssClass="inpt"></asp:TextBox>类型：<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True"
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="shopname" HeaderText="案例名称">
