...
<ItemTemplate>
<li><a href="Proxy<%#Eval("id") %>.html" class='<%# getCss(Eval("id").ToString()) %>'><%#Eval("title") %></a></li>
 </ItemTemplate>
</asp:Repeater>
</ul>
...
<div class="ntt">
<h2>代理加盟</h2>
<span>您当前位置：<a href="Default.html">网站首页</a>  >>  <a href="Proxy.html">代理加盟</a>  >>  <%=title %></span></div>
