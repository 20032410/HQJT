<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addproject.aspx.cs" Inherits="admin_addproject"
    ...
    <form id="Form1" runat="server">
        <table style="width: 100%;" cellspacing="1" border="0" bgcolor="#3e97b9" cellpadding="0">
            ...
            <td align="right" style="height: 24px; width: 15%;">
                    使用产品：</td>
                <td align="left" style="padding-left: 16px; height: 24px;" colspan="3">
                    <asp:TextBox ID="info" runat="server" CssClass="inpt" Width="400px" Height="40px" TextMode="MultiLine"></asp:TextBox></td>
               </tr> 
            <tr>
