<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Interaction.aspx.cs" Inherits="Interaction" %>
...
<dd class="tr_tit"><a href="interview_<%#Eval("id")%>.html"> <%#Eval("shopname") %></a></dd>
<dd><%#Eval("info") %> </dd>
<dd class="more"><a href="interview_<%#Eval("id")%>.html">>>查看详情</a></dd>
</dl>
</ItemTemplate>
</asp:Repeater>
</div>
...
<div style="height:24px; line-height:24px;  clear:both; padding-bottom:10px;  text-align:right"><webdiyer:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="True" CssClass="anpager"
                                             ...
                                             UrlRewritePattern="./Interaction{0}.html">
