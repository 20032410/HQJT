<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Downlist.aspx.cs" Inherits="Downlist" %>
...
<div class="ntt">
<h2>下载中心</h2>
<span>您当前位置：<a href="Default.html">网站首页</a>  >>  <a href="Download.html">下载中心</a> </span></div>
<div class="pro">
<asp:Repeater ID="Repeater1" runat="server" >
<ItemTemplate>
<dl>
<dt><a href="Downview_<%#Eval("type")%>_<%#Eval("id")%>.html"><img src="admin/<%#Eval("images")%>" /></a></dt>
<dd class="tr_tit"><a href="Downview_<%#Eval("type")%>_<%#Eval("id")%>.html"> <%#Eval("shopname") %></a></dd>
<dd><%#Eval("info") %> </dd>
<dd class="more"><a href="Downview_<%#Eval("type")%>_<%#Eval("id")%>.html">>>查看详情</a></dd>
</dl>
</ItemTemplate>
</asp:Repeater>
</div>
...
<div style="height:24px; line-height:24px; clear:both; padding-bottom:10px; text-align:right"><webdiyer:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="True" CssClass="anpager"
                                             ...
                                             UrlRewritePattern="./Downlist%type%-{0}.html">
