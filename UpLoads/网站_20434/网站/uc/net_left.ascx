<%@ Control Language="C#" AutoEventWireup="true" CodeFile="net_left.ascx.cs" Inherits="uc_net_left" %>
<div class="nleft">
<div class="nltop"></div>
<div class="nlbg">
...
<ItemTemplate>
<li><a href="netview_<%#Eval("id") %>.html" class='<%# getCss(Eval("id").ToString()) %>'><%#Eval("shopname") %></a></li>
 </ItemTemplate>
</asp:Repeater>
</ul>
